        ...
        <>
            <header className="eticket">
                <nav className="eticket__nav">
                    <a href="/" className="eticket__nav-back"><IoIosArrowBack /></a>
            ...
            <main className="eticket-content">
                <section className="eticket-content__instruction">
                    ...
                    <p className="eticket-content__instruction-text">Come to the cinema, show and scan the barcode to the space provided. Continue to comply with health protocols.</p>
                </section>

                <section className="eticket-content__details">
                    <div className="eticket-content__ticket">
                    <div className="eticket-content__film">
                        <h5 className="eticket-content__film-title">Film: { }
                            <span className="eticket-content__film-name">e-ticket</span></h5>
                    </div>

                    <div className="eticket-content__info">
                        <ul className="eticket-content__info-list">
                            <li className="eticket-content__info-item"><p>Date<span className="eticket-content__info-value">{ }</span></p></li>
                            <li className="eticket-content__info-item"><p>Seats <span className="eticket-content__info-value">{ }</span></p></li>
                            <li className="eticket-content__info-item"><p>Location <span className="eticket-content__info-value">{ }</span></p></li>
                            <li className="eticket-content__info-item"><p>Time <span className="eticket-content__info-value">{ }</span></p></li>
                            <li className="eticket-content__info-item"><p>Payment <span className="eticket-content__info-value">{ }</span></p></li>
                            <li className="eticket-content__info-item"><p>Order <span className="eticket-content__info-value">{ }</span></p></li>
                        </ul>
                        </div> 
                        </div>

...
function ETicket() {
    ...
    const movieTitle = localStorage.getItem(`movie_${movieId}`) || 'Unknown Movie';
                    ...
                    <div className="eticket-content__ticket">
                        <div className="eticket-content__film">
                            <h5 className="eticket-content__film-title">
                                Film: <span className="eticket-content__film-name">{movieTitle}</span>
                            </h5>
                        </div>
                        ...
                        <div className="eticket-content__info">
                            <ul className="eticket-content__info-list">
                                ...
                                <li className="eticket-content__info-item">
                                    <p>Seats <span className="eticket-content__info-value">{selectedSeats.join(', ')}</span></p>
                                </li>
                                <li className="eticket-content__info-item">
...
<div className="eticket-content__button">  <button className="download-button">Download E-Ticket</button></div>
